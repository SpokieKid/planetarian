export const events = {
  Era1_Discovery_Prosperity01: {
    ...
    title: "星空的低语",
    era: 1,
    karmaLevel: [1, 90], // Representing the range (71, 90)
    turns: [1, 49], // Representing the range 1-49
    narrative:
      `在星球文明繁荣的光辉下，探索引擎全速运转。低维度生命的目光投向更遥远的未知。通过改进的早期天文设备或长距离通讯技术，探测到来自地表之外、甚至可能来自其他星球的重复性、非自然信号。这些信号极其微弱，难以捕捉，但在持续的监测中显现出某种规律。`,
    conflict:
    ...
    options: [
      {
        id: "A",
        text: `微妙推动低维文明中对未知信号的积极回应倾向。引导其集体意识聚焦于“机遇”、“宇宙中的潜在盟友”、“知识的飞跃”等概念。`,
      ...
      {
        id: "B",
        text: `强化低维文明中对潜在风险的警惕意识。引导其集体意识关注于“未知威胁”、“盲目投入的愚蠢”、“保持隔离的安全”等概念。`,
